...
<!--3.Sea view suit suit-->
  ...
  <!--4.Twin Superior Room-->
  <div class="room-1">
    <img src="image/room4.jpg" alt="room4" height="240px" class="roomimg">
    <h3>Twin Superior Room</h3>
    <button type="button" class="btn-4" id="openroomd4"><p>Room details >></p></button>

    <div id="myModal4" class="modal">
      <div class="modal-content">
        <span class="close">&times;</span>
        <h3>Room Details</h3>
        <p><strong>Room Type:</strong> Twin superior room</p>
        <p><strong>Price:</strong> $350 per night</p>
        <p><strong>Features:</strong> Sleeps 3,Mini refrigerator,Separate toilet area,300 thread count sheets,Bathroom amenities,Bathrobe,Mini bar,Air conditioning</p>
        <p><strong>Description:</strong> Enjoy awe-inspiring vistas from this guest room, which boasts twin beds and a cozy seating area complemented by a sofa. Make use of the workstation for work or study, connect to the internet via available WiFi, or unwind with a movie on the television.</p>
      </div>
    </div>
    <br>
    <button type="button" class="bookbtn"><a href="billdetails.php" target="_blank">Book now for $350</a></button>
  </div>

   <!--5.King Superior Room-->
  <div class="room-1">
    <img src="image/room5.jpg" alt="room5" height="240px" class="roomimg">
    <h3>King Superior Room</h3>
    <button type="button" class="btn-4" id="openroomd5"><p>Room details >></p></button>

    <div id="myModal5" class="modal">
      <div class="modal-content">
        <span class="close">&times;</span>
        <h3>Room Details</h3>
        <p><strong>Room Type:</strong> King Superior Room</p>
        <p><strong>Price:</strong> $220 per night</p>
        <p><strong>Features:</strong> Sleeps 3, Mini refrigerator, Separate toilet area, 300 thread count sheets, Hairdryer, Iron/ironing board, Bathroom amenities, Bathrobe,Mini bar</p>
        <p><strong>Description:</strong> Enjoy stunning vistas from this elegant guest room, which boasts a king-sized bed and a cozy seating area featuring a sofa. For work or leisure, make use of the desk, connect to the internet via WiFi, or unwind with a movie on the television.</p>
      </div>
    </div>
    <br>
    <button type="button" class="bookbtn"><a href="billdetails.php" target="_blank">Book now for $220</a></button>
  </div>

<!--6.Twin Deluxe Sea View Room-->
  <div class="room-1">
    <img src="image/room6.jpg" alt="room6" height="240px" class="roomimg">
    <h3>Twin Deluxe Sea View Room</h3>
    <button type="button" class="btn-4" id="openroomd6"><p>Room details >></p></button>

    <div id="myModal6" class="modal">
      <div class="modal-content">
        <span class="close">&times;</span>
        <h3>Room Details</h3>
        <p><strong>Room Type:</strong> Twin Deluxe Sea View Room</p>
        <p><strong>Price:</strong> $400 per night</p>
        <p><strong>Features:</strong> Sleeps 3, Seating area with sofa, 300 thread count sheets, Iron/ironing board, Bathroom amenities, Mini bar</p>
        <p><strong>Description:</strong> Experience breathtaking vistas of the ocean from this spacious guest room, featuring twin beds and a comfortable seating arrangement complete with a sofa. Thoughtful additions such as newspapers, a plush bathrobe, cozy slippers, refreshing mineral water, and a selection of fresh fruit are provided to enhance your stay.</p>
      </div>
    </div>
    <br>
    <button type="button" class="bookbtn"><a href="billdetails.php" target="_blank">Book now for $400</a></button>
  </div>

  <!--7.Twin Executive Room-->
  <div class="room-1">
    <img src="image/room7.jpg" alt="room7" height="240px" class="roomimg">
    <h3>Twin Executive Room</h3>
    <button type="button" class="btn-4" id="openroomd10"><p>Room details >></p></button>

    <div id="myModal10" class="modal">
      <div class="modal-content">
        <span class="close">&times;</span>
        <h3>Room Details</h3>
        <p><strong>Room Type:</strong>Twin Executive Room</p>
        <p><strong>Price:</strong> $500 per night</p>
        <p><strong>Features:</strong> Sleeps 3, Mini refrigerator, Seating area with sofa, 250 thread count sheets ,Hairdryer, Iron, Iron/ironing board, Bathroom amenities</p>
        <p><strong>Description:</strong> Ocean view, Executive Lounge access, larger room, seating area with sofa, work area Relax in this spacious guest room and take advantage of Executive Lounge access with refreshments.</p>
      </div>
    </div>
    <br>
    <button type="button" class="bookbtn"><a href="billdetails.php" target="_blank">Book now for $500</a></button>
  </div>

  <!--8.King Executive Room-->
  <div class="room-1">
    <img src="image/room8.jpg" alt="room8" height="240px" class="roomimg">
    <h3>King Executive Room</h3>
    <button type="button" class="btn-4" id="openroomd11"><p>Room details >></p></button>

    <div id="myModal11" class="modal">
      <div class="modal-content">
        <span class="close">&times;</span>
        <h3>Room Details</h3>
        <p><strong>Room Type:</strong> King Executive Room</p>
        <p><strong>Price:</strong> $700 per night</p>
        <p><strong>Features:</strong> Sleeps 3, Mini refrigerator, Seating area with sofa, 250 thread count sheets ,Hairdryer, Iron, Iron/ironing board, Bathroom amenities, Mini bar, Radio alarm clock</p>
        <p><strong>Description:</strong>  Ocean view, Executive Lounge access, larger room, seating area with sofa, work area Relax in this spacious guest room and take advantage of Executive Lounge access with refreshments.</p>
      </div>
    </div>
    <br>
    <button type="button" class="bookbtn"><a href="billdetails.php" target="_blank">Book now for $700</a></button>
  </div>
