...
<header>
    ...
    <div class="line1">
        ...
        <button id="btn1" class="find"><a href="../../../My/src/find stay.phpd%20stay.html">Find Stay</a></button>
...
<body>
  ...
  <div class="room-1">
    ...
    <button type="button" class="btn-4" id="openroomd12"><p>Room details >></p></button>
  ...
  <div class="room-1">
    ...
    <button type="button" class="btn-4" id="openroomd13"><p>Room details >></p></button>
...
<script src="executivejs.js"></script>
</body>
